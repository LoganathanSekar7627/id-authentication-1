...
@Import(value = { UinValidatorImpl.class, VidValidatorImpl.class, IDAMappingConfig.class, KeyManager.class,
		...
		DemoNormalizerImpl.class, OTPServiceImpl.class, OTPRequestValidator.class, IdAuthSecurityManager.class,
		...
		IdTypeUtil.class, MasterDataCache.class, PartnerServiceCache.class, PartnerCertificateManagerServiceImpl.class, PartnerCertManagerDBHelper.class, WebSubHelper.class,
